                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mt-4">
                        @if ($sensor->latitude && $sensor->longitude)
                            <a 
                                href="{{ url('/map_view.php?lat=' . $sensor->latitude . '&lng=' . $sensor->longitude) }}" 
                                target="_blank" 
                                class="gray-tit"
                            >
                                Ver en el Mapa
                        ...
                        @else
                            <p class="text-red-500">La latitud y longitud no están disponibles para este sensor.</p>
                        @endif
                    </div>

                    <!-- Gráfica -->
                    <h3 class="text-lg font-bold mb-4 mt-6">Gráfica de Lecturas (10 últimas lecturas)</h3>
