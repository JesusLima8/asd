    ...
    <div class="flex">
        ...
        <aside class="user-option-title">
            @if (Auth::user()->role === 'admin')
                ...
                <h3>
                    <button 
                        class="user-option-title w-full text-left px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded"
                ...
                <li style="list-style: none;">
                    <button 
                        class="user-option-title w-full text-left px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded mt-4"
                        onclick="toggleMenu('user-options')">
                        {{ __('Opciones de Usuario') }}
                    </button>
                    <ul id="user-options" class="hidden w-full hidden space-y-1 pl-6 mt-2" style="list-style: none;">
                        <li style="list-style: none;">
            ...
            @else
                ...
                <li style="list-style: none;">
                    ...
                    <ul id="user-options" class=" hidden space-y-1 pl-6 mt-2" style="list-style: none;">
                        <li style="list-style: none;">
                            <a href="{{ route('sensors.list') }}" 
                            class="user-option-item w-full text-left px-4 py-2 bg-blue-400 hover:bg-blue-500 text-white rounded">
                                {{ ('Ver Sensores') }}
