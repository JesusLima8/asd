    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.sensors.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="image" class="block text-base font-medium">Subir Imagen:</label>
                            <input type="file" id="image" name="image" accept="image/*" class="mt-1 text-black block w-full border-gray-300 rounded-md shadow-sm">
                        </div>
